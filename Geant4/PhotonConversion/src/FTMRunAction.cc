  ...
  fEdep2(0.)
{
  ...
  /*ID 8*/ analysisManager->CreateH1("EkSecondariesGen","Ek of secondariy electrons generated in FR4", 1000, 0., 1*MeV);
  
  /*ID 9*/ analysisManager->CreateH1("NsecondariesBottom_out","Total number of secondary electrons incoming in Bottom per event", 10, 0., 10);
    
  /*ID 10*/ analysisManager->CreateH1("NsecondariesBottom_count","Counting secondary electrons in Bottom", 5, 0., 5);
  /*ID 11*/ analysisManager->CreateH1("EkSecondariesBottom","Ek of secondariy electrons in Bottom", 1000, 0., 1*MeV);
    
  /*ID 12*/ analysisManager->CreateH1("NprimariesTop","Total number of primary particles on the Top surface per event", 5, 0., 5);
  /*ID 13*/ analysisManager->CreateH1("NprimariesTop_count","Counting primaries gamma in Top", 5, 0., 5);
    
  /*ID 14*/ analysisManager->CreateH1("NprimariesBottom_count","Counting primary gammas in Bottom", 5, 0., 5);
  /*ID 15*/ analysisManager->CreateH1("EkPrimariesBottom","Ek of primary gammas in Bottom", 1000, 0., 1*MeV);
    
  /*ID 16*/ analysisManager->CreateH1("EkSecondariesGenBottom","Ek Gen of secondariy electrons in Bottom", 1000, 0., 1*MeV);
